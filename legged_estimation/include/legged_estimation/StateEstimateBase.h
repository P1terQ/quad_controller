...
class StateEstimateBase {
 public:
  ...
  virtual Eigen::Matrix<double, 3, 1> getvel_basefrane(void) = 0;
  virtual Eigen::Matrix<double, 4, 1> get_localfoot_H(void) = 0;
  virtual scalar_t get_terrain_angle(void) = 0;
